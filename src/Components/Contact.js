            ...
            <div className="container">
                <div className="row justify-content-md-center">
                    <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                        <h2 className="fs-8 mb-4 text-primary strongly display-3 text-center">Let's Connect</h2>
                        <p className="text-secondary fs-5 mb-5 text-center">Contact our support team or make an appointment with our experts.</p>
